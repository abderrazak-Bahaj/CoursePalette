        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <Card className="p-8 mb-8">
              <p className="mb-6">
                Please read these Terms of Service carefully before using the CoursePalette platform. 
                These Terms govern your access to and use of the services, websites, and applications 
                offered by CoursePalette.
              </p>
              ...
              <section id="acceptance" className="mb-8">
                ...
                <p className="mb-4">
                  By accessing or using the CoursePalette platform, you agree to be bound by these Terms 
              ...
              <section id="accounts" className="mb-8">
                ...
                <p className="mb-4">
                  ...
                  which may result in immediate termination of your account on our platform.
                </p>
                <p className="mb-4">
                  ...
                  to any third party. You must notify us immediately upon becoming aware of any breach of 
              ...
              <section id="content" className="mb-8">
                ...
                <p className="mb-4">
                  ...
                  that you post on or through the platform, including its legality, reliability, and appropriateness.
                </p>
                <p className="mb-4">
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
                  ...
                  <li>The posting of your content on or through the platform does not violate the privacy rights, publicity rights, copyrights, contract rights or any other rights of any person.</li>
                </ul>
                <p className="mb-4">
                  We reserve the right to remove any content from the platform at our discretion, without prior notice, 
              ...
              <section id="contact" className="mt-8">
                ...
                <p className="mt-2">
                  <strong>Email:</strong> legal@coursepalette.com<br />
                  <strong>Address:</strong> 123 Education Street, San Francisco, CA 94107, United States<br />
