...
const AdminAssignmentsPage = () => {
  ...
  const { data: allAssignmentsData, isLoading: assignmentsLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      const allAssignments: Array<Assignment & { course_title: string; course_id: string }> = [];
      ...
      for (const course of courses) {
        try {
          ...
          const assignmentsResponse = await courseService.getCourseAssignments(course.id, params);
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold">{assignmentStats.draft}</p>
                </div>
              </div>
            </CardContent>
          </Card>
                  ...
                  <div className="flex items-start justify-between">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            ...
                            <p className="font-medium">{assignment.questions_count || 0}</p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            ...
                            <p className="font-medium">{assignment.submissions_count || 0}</p>
                          </div>
                        </div>
                    ...
                    <div className="flex items-center gap-2 ml-4">
                      <Button
                        ...
                        className="flex items-center gap-2"
                      >
                        <Link to={`/admin/courses/${assignment.course_id}/assignments`}>
                      ...
                      <Button
                        ...
                        className="flex items-center gap-2"
                      >
                        <Link to={`/admin/courses/${assignment.course_id}/assignments/${assignment.id}/submissions`}>
