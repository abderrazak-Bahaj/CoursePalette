...
export const mockCourses: Course[] = [
  ...
  },
  {
    ...
    level: 'Intermediate',
    description:
      'Strategy, design, development & implementation — all in one course. Learn user experience design principles and tools.',
    duration: '26 hours',
    enrolledCount: 11245,
    skills: [
      'UI Design',
  ...
  },
  {
    ...
    level: 'Advanced',
    description:
      'Learn to create AI models for Self-Driving Cars, Computer Vision, and more. Implement AI algorithms from scratch.',
    duration: '36 hours',
    enrolledCount: 8765,
    skills: [
      'AI',
