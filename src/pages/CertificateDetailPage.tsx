    ...
    return (
      <MainLayout>
        <div className="container mx-auto px-4 py-16 text-center">
          ...
          <p className="mb-6">The certificate you are looking for does not exist.</p>
          <Button asChild>
              ...
              <Card className="p-6 mb-6 print:shadow-none print:border-0">
                ...
                <div className="border-4 border-gray-300 p-8 mb-6 bg-white print:p-4 print:border-0">
                  <div className="text-center">
                    <div className="text-gray-400 text-sm mb-2">COURSEPALETTE</div>
                    <div className="text-3xl font-bold mb-1 text-course-blue">CERTIFICATE OF COMPLETION</div>
                    ...
                    <div className="mb-6 text-lg">has successfully completed the online course</div>
                    
                    <div className="text-2xl font-bold mb-6">{certificate.courseName}</div>
            ...
            <div className="lg:w-1/3 print:hidden">
              <Card className="p-6 mb-6">
                ...
                <div className="space-y-4">
                  <div>
                    <div className="text-sm text-gray-500 mb-1">Certificate Name</div>
              ...
              <Card className="p-6">
                ...
                <p className="text-gray-600 mb-4">
                  This certificate can be verified by potential employers 
                  or educational institutions using the Certificate ID.
                </p>
