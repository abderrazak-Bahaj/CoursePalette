        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <Card className="p-8 mb-8">
              <p className="mb-6">
                At CoursePalette, we respect your privacy and are committed to protecting your personal data. 
              ...
              <section id="information" className="mb-8">
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  <li><strong>Personal Information:</strong> Name, email address, phone number, billing address, payment information, and academic history.</li>
                  <li><strong>Profile Information:</strong> Profile photos, biographical information, and educational background.</li>
                  <li><strong>User Contributions:</strong> Course reviews, forum posts, and other content you contribute to the platform.</li>
                  <li><strong>Engagement Data:</strong> Course progress, quiz scores, completion rates, and learning patterns.</li>
              ...
              <section id="usage" className="mb-8">
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  ...
                  <li>Sending administrative information and important updates</li>
              ...
              <section id="sharing" className="mb-8">
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  ...
                  <li><strong>Instructors:</strong> Course instructors have access to student data related to their courses.</li>
              ...
              <section id="contact" className="mt-8">
                ...
                <p className="mt-2">
                  <strong>Email:</strong> privacy@coursepalette.com<br />
