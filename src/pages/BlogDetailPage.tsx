...
import { ChevronLeft, Calendar, Clock, Share2, Bookmark, MessageSquare, Facebook, Twitter, Linkedin } from "lucide-react";
...
console.log(multiply(2, 3)); // Outputs: 6
    ...
    authorBio: "Dr. Alex Johnson has over 10 years of experience in web development and has taught thousands of students through online courses and workshops.",
  ...
  },
  {
    ...
    authorBio: "Sarah Williams specializes in online learning methodologies and has conducted extensive research on effective digital education practices.",
  ...
  },
  {
    ...
    authorBio: "Michael Chen is a professor of Data Science with a focus on machine learning applications in business and healthcare.",
  ...
  },
  {
    ...
    authorBio: "James Wilson has developed over 20 successful mobile applications and runs a popular YouTube channel teaching app development.",
  ...
  },
  {
    ...
    authorBio: "Maria Garcia has worked with major educational institutions to implement cloud solutions that enhance learning experiences.",
    authorAvatar: "https://randomuser.me/api/portraits/women/6.jpg",
    date: "September 22, 2023",
    category: "Cloud Computing",
    readTime: "7 min read",
    tags: ["Cloud Computing", "Education Technology", "Future Tech"],
    image: "https://images.unsplash.com/photo-1584854444132-6df1938fedf4?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80",
    comments: 5,
    related: [2, 3, 6]
  },
  {
    ...
    authorBio: "Lisa Roberts bridges the gap between design and development, helping teams create more user-friendly digital experiences.",
...
const BlogDetailPage = () => {
  ...
  const relatedPosts = post.related.map(id => mockBlogPosts.find(p => p.id === id.toString())).filter(Boolean);
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <div className="mx-auto max-w-4xl">
            ...
            <div className="prose prose-lg max-w-none mb-10" dangerouslySetInnerHTML={{ __html: post.content }}></div>
                  ...
                  <Link to={`/blog/${relatedPost?.id}`} key={relatedPost?.id}>
                    <Card className="h-full hover:shadow-md transition-shadow">
                      ...
                      <CardHeader className="pb-2">
                        <Badge variant="outline" className="mb-2 inline-flex">{relatedPost?.category}</Badge>
