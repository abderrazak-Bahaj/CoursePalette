          ...
          <Card>
            <CardContent className="py-10">
              <p className="text-center">
                The requested student could not be found or you don't have permission to view this information.
              </p>
              ...
              <Tabs defaultValue="info">
                ...
                <TabsContent value="info" className="space-y-6 pt-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="flex items-center">
                        ...
                        <p>{student?.student?.date_of_birth ? formatDate(student.student.date_of_birth) : 'Not provided'}</p>
                      </div>
                    </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-sm">{student?.bio || 'No biography provided.'}</p>
                  </div>

                  {student?.student?.interests && student.student.interests.length > 0 && (
                    <div className="space-y-2">
                      <p className="text-sm font-medium text-muted-foreground">Interests</p>
                      <div className="flex flex-wrap gap-2">
                        {student.student.interests.map((interest, index) => (
                  ...
                  {student?.student?.learning_preferences && student.student.learning_preferences.length > 0 && (
                    <div className="space-y-2">
                      <p className="text-sm font-medium text-muted-foreground">Learning Preferences</p>
                      <div className="flex flex-wrap gap-2">
                        {student.student.learning_preferences.map((preference, index) => (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <Card>
                      <CardContent className="p-4">
                        ...
                        <p>{student?.student?.education_level || 'Not specified'}</p>
                      </CardContent>
                    </Card>
                    ...
                    <Card>
                      <CardContent className="p-4">
                        ...
                        <Badge className={getStatusColor(student?.student?.enrollment_status || 'INACTIVE')}>
                          {student?.student?.enrollment_status || 'Not specified'}
                        </Badge>
                      </CardContent>
                    </Card>
                  </div>
                ...
                <TabsContent value="courses" className="pt-4">
                  {student?.my_enrollments && student.my_enrollments.length > 0 ? (
                    ...
                    <div className="text-center py-8">
                      ...
                      <p className="text-muted-foreground">This student hasn't enrolled in any courses yet.</p>
                    </div>
                  )}
                </TabsContent>
