...
const HideCertificate = forwardRef<HTMLDivElement, DisplayCertificateProps>(
  ({ certificate }, ref) => {
    return (
      <div
        ref={ref}
        className={`relative bg-white border-8 border-gray-300 `}
        style={{
          width: '100%',
          maxWidth: '842pt', // A4 width in points
          aspectRatio: '842/595', // A4 aspect ratio
          padding: '40pt',
          margin: '0 auto',
...
HideCertificate.displayName = 'DisplayCertificate';

export default HideCertificate;
