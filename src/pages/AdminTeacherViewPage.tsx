          ...
          <Card>
            <CardContent className="py-10">
              <p className="text-center">
                The requested teacher could not be found or you don't have
              ...
              <CardContent>
                <Tabs defaultValue="info">
                  ...
                  <TabsContent value="info" className="space-y-6 pt-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-1">
                        ...
                        <p>
                          {teacher?.teacher?.specialization || 'Not specified'}
                        </p>
                      </div>
                      ...
                      <div className="space-y-1">
                        ...
                        <p>
                          {teacher?.teacher?.years_of_experience
                            ? `${teacher?.teacher?.years_of_experience} years`
                            : 'Not specified'}
                        </p>
                      </div>
                      ...
                      <div className="space-y-1">
                        ...
                        <p>
                          {teacher?.teacher?.qualification || 'Not specified'}
                        </p>
                      </div>
                  ...
                  <TabsContent value="education" className="space-y-6 pt-4">
                    ...
                    teacher?.teacher?.education.length > 0 ? (
                      ...
                      <div className="text-center py-8">
                        ...
                        <p className="text-muted-foreground">
                          No education details have been provided.
                        </p>
                      </div>
                    )}

                    {teacher?.teacher?.certifications &&
                      teacher?.teacher?.certifications.length > 0 && (
                        <div className="space-y-4 mt-8">
                          ...
                          <div className="space-y-4">
                            {teacher?.teacher?.certifications.map(
                              (cert, index) => (
                                <Card key={index}>
                                  <CardContent className="p-4">
                                    <div className="flex items-center justify-between">
